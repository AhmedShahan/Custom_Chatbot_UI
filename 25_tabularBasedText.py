...
if __name__ == "__main__":
    PDF_PATH = "/home/shahanahmed/Documents/pdf1.pdf"  # Update this path to your PDF file

    rag1 = RAGSystem(model_name="gemma3:latest")
    rag1.ingest_pdf(PDF_PATH)

    rag2 = RAGSystem(model_name="deepseek-r1:14b")
    rag2.ingest_pdf(PDF_PATH)

    rag3 = RAGSystem(model_name="llama3.2:1b")
